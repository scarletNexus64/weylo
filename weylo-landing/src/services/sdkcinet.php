...
La fonction Payment permet de rediriger l'utilisateur sur un lien de paiement Vous trouverez plus d'informations sur la documentation:
...
...
La fonction notify_url vous permet de recevoir des notifications et mettre à jour votre système.
Pour ceux qui possèdent des services qui ne nécessitent pas un traitement des notifications de paiement de CinetPay, vous pouvez passer directement à la phase suivante, par exemple les services de don.

La fonction de return_url permet de rediriger le client après une transaction sur CinetPay (quelque soit le statut de la transaction).
