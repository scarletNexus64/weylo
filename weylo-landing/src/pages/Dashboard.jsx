...
export default function Dashboard() {
  ...
  // Générer le lien dynamiquement selon l'environnement (IP, DNS, 10.202.205.28, production)
  const getBaseUrl = () => {
  ...
  const shareToSocial = (platform) => {
    ...
    const urls = {
      ...
      instagram: shareLink, // Copy link for Instagram story
    }
  ...
  return (
    <div className="dashboard">
      ...
      <div className="share-section">
        <h2>Partage ton lien Weylo</h2>
        <p>Reçois des messages anonymes de tes amis</p>
        ...
        <div className="social-share">
          <button onClick={() => shareToSocial('whatsapp')} className="share-btn whatsapp">
